      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            <div
              key={insight.title}
              className="stat-card card-glow p-8 border border-border rounded-lg animate-fade-up opacity-0"
              style={{ 
        ...
        <div className="mt-16 text-center">
          <div className="inline-block p-6 bg-card/50 border border-border rounded-lg">
